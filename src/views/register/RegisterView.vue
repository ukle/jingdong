<template>
  <div class="wrapper">
    ...
    <div class="wrapper__input">
      <input class="wrapper__input__content" placeholder="确认密码" type="password" v-model="ensurement" autocomplete="new-password"/>
    </div>
...
const useRegisterEffect = (showToast) => {
  ...
  const handleRegister = async () => {
    try {
      const result = await post('/api/sys/user/create', {
...
export default {
  ...
  setup () {
    ...
    return { username, password, ensurement, show, toastMsg, handleRegister, handleLoginClick }
  }
}
</script>
